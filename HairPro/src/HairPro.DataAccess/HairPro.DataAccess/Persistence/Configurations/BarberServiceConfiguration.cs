...
namespace HairPro.DataAccess.Persistence.Configurations
{
    public class BarberServiceConfiguration : IEntityTypeConfiguration<BarberService>
    {
        public void Configure(EntityTypeBuilder<BarberService> builder)
        {
            ...
            // Audit maydonlari
            builder
                .Property(bs => bs.CreatedBy)
                .HasMaxLength(100)
                .IsRequired();

            builder
                .Property(bs => bs.UpdatedBy)
                .HasMaxLength(100)
                .IsRequired(false);
            ...
            builder
                .Property(bs => bs.UpdatedOn)
                .IsRequired(false);

            // Unique constraint qo‘shish (bitta sartarosh bitta xizmatni faqat bir marta qo‘shishi mumkin)
            builder
